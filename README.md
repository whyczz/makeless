...
- [ ] **Day 1: Data & Counting**
  - [ ] Load the `names.txt` dataset and explore it [[00:03:04]](https://youtu.be/PaCmpygFfXo?t=3m4s).
  - [ ] Create character-to-integer (`stoi`) and integer-to-character (`itos`) mappings.
  - [ ] Build a 2D integer tensor `N` of shape `[27, 27]` to count bigram frequencies [[00:09:26]](https://youtu.be/PaCmpygFfXo?t=9m26s).
